...
export default {
  ...
  // cacheDirectory: "/private/var/folders/jj/hd62yw4s1x394tjfht4gcnvh0000gn/T/jest_dx",
  ...
  // the environment after tests are run
  // setupFilesAfterEnv: [],

  // The number of seconds after which a test is considered as slow and
  // will be reported as such in the results.
  // slowTestThreshold: 5,
  ...
  // before resources will be transformed during testing
